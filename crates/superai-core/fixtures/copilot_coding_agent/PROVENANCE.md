# Provenance — copilot_coding_agent fixtures
...
|---|---|---|
| copilot-instructions.minimal.md | TextFragment | minimal AGENTS-level instructions |
| copilot-instructions.populated.md | TextFragment | populated with setup/validation |
| setup-steps.minimal.yml | Yaml | minimal Actions workflow |
| setup-steps.populated.yml | Yaml | populated copilot-setup-steps.yml with permissions |
